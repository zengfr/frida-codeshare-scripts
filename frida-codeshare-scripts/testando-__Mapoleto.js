...
//hash:-1993038384 @Mapoleto/testando-
...
//////////////////////////////////////////////////////////////////////////////////////////////
try {
// Bypass HttpCertificatePinningPlugin.check {1}
var HttpCertificatePinningPlugin_Activity = Java.use('diefferson.http_certificate_pinning.HttpCertificatePinningPlugin');
HttpCertificatePinningPlugin_Activity.checkConnexion.overload("java.lang.String", "java.util.List", "java.util.Map", "int", "java.lang.String").implementation = function (a, b, c ,d, e) {
console.log('[+] Bypassing Flutter HttpCertificatePinningPlugin : ' + a);
return true;
};
} catch (err) {
console.log('[-] Flutter HttpCertificatePinningPlugin pinner not found');
//console.log(err);
}
try {
