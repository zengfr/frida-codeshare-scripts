...
//hash:-382397100 @lnaphade/risingstar
/*  Android All in one bypass script for various methods
by Lalit Naphade

Run with:

frida -U -f <APP_ID> -l frida_risingstar.js
*/
...
setTimeout(function() {
    Java.perform(function() {
        ...
        // SSL/TLS Trapper bypass script (Android all versions) //


        // Antiroot bypass script (Android all versions) //
        {
